...
CBSA_CATALOG: List[Cbsa] = [
    Cbsa("35620", "New York-Newark-Jersey City, NY-NJ", "NY", 0.09, 40.7128, -74.0060),
    Cbsa("31080", "Los Angeles-Long Beach-Anaheim, CA", "CA", 0.08, 34.0522, -118.2437),
    Cbsa("16980", "Chicago-Naperville-Elgin, IL", "IL", 0.06, 41.8781, -87.6298),
    Cbsa("26420", "Houston-The Woodlands-Sugar Land, TX", "TX", 0.05, 29.7604, -95.3698),
    Cbsa("19100", "Dallas-Fort Worth-Arlington, TX", "TX", 0.05, 32.7767, -96.7970),
    Cbsa("47900", "Washington-Arlington-Alexandria, DC-VA", "VA", 0.04, 38.9072, -77.0369),
    Cbsa("33100", "Miami-Fort Lauderdale-Pompano Beach, FL", "FL", 0.04, 25.7617, -80.1918),
    Cbsa("37980", "Philadelphia-Camden-Wilmington, PA-NJ-DE", "PA", 0.04, 39.9526, -75.1652),
    Cbsa("12060", "Atlanta-Sandy Springs-Alpharetta, GA", "GA", 0.04, 33.7490, -84.3880),
    Cbsa("38060", "Phoenix-Mesa-Chandler, AZ", "AZ", 0.04, 33.4484, -112.0740),
    Cbsa("14460", "Boston-Cambridge-Newton, MA-NH", "MA", 0.04, 42.3601, -71.0589),
    Cbsa("41860", "San Francisco-Oakland-Berkeley, CA", "CA", 0.04, 37.7749, -122.4194),
    Cbsa("40140", "Riverside-San Bernardino-Ontario, CA", "CA", 0.03, 34.0522, -117.2437),
    Cbsa("19820", "Detroit-Warren-Dearborn, MI", "MI", 0.03, 42.3314, -83.0458),
    Cbsa("42660", "Seattle-Tacoma-Bellevue, WA", "WA", 0.03, 47.6062, -122.3321),
    Cbsa("33460", "Minneapolis-St. Paul-Bloomington, MN-WI", "MN", 0.03, 44.9778, -93.2650),
    Cbsa("41740", "San Diego-Chula Vista-Carlsbad, CA", "CA", 0.03, 32.7157, -117.1611),
    Cbsa("45300", "Tampa-St. Petersburg-Clearwater, FL", "FL", 0.03, 27.9506, -82.4572),
    Cbsa("19740", "Denver-Aurora-Lakewood, CO", "CO", 0.03, 39.7392, -104.9903),
    Cbsa("12580", "Baltimore-Columbia-Towson, MD", "MD", 0.025, 39.2904, -76.6122),
    Cbsa("16740", "Charlotte-Concord-Gastonia, NC-SC", "NC", 0.025, 35.2271, -80.8431),
    Cbsa("41180", "St. Louis, MO-IL", "MO", 0.025, 38.6270, -90.1994),
    Cbsa("36740", "Orlando-Kissimmee-Sanford, FL", "FL", 0.025, 28.5383, -81.3792),
    Cbsa("38900", "Portland-Vancouver-Hillsboro, OR-WA", "OR", 0.025, 45.5152, -122.6784),
    Cbsa("40900", "Sacramento-Roseville-Folsom, CA", "CA", 0.02, 38.5816, -121.4944),
    Cbsa("29820", "Las Vegas-Henderson-Paradise, NV", "NV", 0.02, 36.1699, -115.1398),
    Cbsa("41700", "San Antonio-New Braunfels, TX", "TX", 0.02, 29.4241, -98.4936),
    Cbsa("34980", "Nashville-Davidson--Murfreesboro--Franklin, TN", "TN", 0.02, 36.1627, -86.7816),
    Cbsa("28140", "Kansas City, MO-KS", "MO", 0.02, 39.0997, -94.5786),
    Cbsa("18140", "Columbus, OH", "OH", 0.02, 39.9612, -82.9988),
    Cbsa("26900", "Indianapolis-Carmel-Anderson, IN", "IN", 0.02, 39.7684, -86.1581),
    Cbsa("38300", "Pittsburgh, PA", "PA", 0.02, 40.4406, -79.9959),
    Cbsa("17140", "Cincinnati, OH-KY-IN", "OH", 0.02, 39.1031, -84.5120),
    Cbsa("17460", "Cleveland-Elyria, OH", "OH", 0.02, 41.4993, -81.6944),
    Cbsa("12420", "Austin-Round Rock-Georgetown, TX", "TX", 0.02, 30.2672, -97.7431),
    Cbsa("39580", "Raleigh-Cary, NC", "NC", 0.02, 35.7796, -78.6382),
    Cbsa("41620", "Salt Lake City, UT", "UT", 0.015, 40.7608, -111.8910),
    Cbsa("33340", "Milwaukee-Waukesha, WI", "WI", 0.015, 43.0389, -87.9065),
    Cbsa("27260", "Jacksonville, FL", "FL", 0.015, 30.3322, -81.6557),
    Cbsa("35380", "New Orleans-Metairie, LA", "LA", 0.015, 29.9511, -90.0715),
    Cbsa("36420", "Oklahoma City, OK", "OK", 0.015, 35.4676, -97.5164),
    Cbsa("32820", "Memphis, TN-MS-AR", "TN", 0.015, 35.1495, -90.0490),
    Cbsa("40060", "Richmond, VA", "VA", 0.015, 37.5407, -77.4360),
    Cbsa("47940", "Worcester, MA-CT", "MA", 0.01, 42.2626, -71.8023),
    Cbsa("23420", "Fresno, CA", "CA", 0.01, 36.7378, -119.7871),
    Cbsa("24660", "Greenville-Anderson, SC", "SC", 0.01, 34.8526, -82.3940),
    Cbsa("44700", "Stockton, CA", "CA", 0.01, 37.9577, -121.2908),
    Cbsa("15380", "Buffalo-Cheektowaga, NY", "NY", 0.01, 42.8864, -78.8784),
    Cbsa("26180", "Harrisburg-Carlisle, PA", "PA", 0.01, 40.2732, -76.8867),
]
