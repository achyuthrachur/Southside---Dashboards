...
Streamlit-based analytics workspace for ingesting quarterly risk datasets,
harmonizing them across canonical schemas, and delivering five investigative
views:

1. **Real Estate PD US Heatmap** – CBSA-level choropleth with occupancy and property segmentation.
...
The implementation roadmap follows the specification provided by the WOW team
